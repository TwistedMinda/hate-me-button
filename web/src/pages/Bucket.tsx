...
import { useBucketInteractions } from 'hooks/useBucketInteractions';
      ...
      <div className="pt-24 grid gap-y-20 bg-red text-center">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] ml-auto mr-auto  text-sm opacity-50`}>
            Show that you care to mention that you hate me!
          </p>
        </a>
        ...
        >
          ...
          <div className={`max-w-[200px] text-sm ml-auto mr-auto opacity-50`}>
            Give much love! Donate straight to bring more joy!
          </div>
        </a>
      </div>
      <Footer />
